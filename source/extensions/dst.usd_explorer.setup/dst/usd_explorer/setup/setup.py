...
ICON_PATH = carb.tokens.get_tokens_interface().resolve("${dst.usd_explorer.setup}/data/icons")
...
class SetupExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id: str) -> None:
        ...
        self._layouts_path = carb.tokens.get_tokens_interface().resolve("${dst.usd_explorer.setup}/layouts")
    ...
    def _custom_quicklayout_menu(self) -> None:
        ...
        def add_layout_menu_entry(name, parameter, key):
            ...
            layouts_path = carb.tokens.get_tokens_interface().resolve("${dst.usd_explorer.setup}/layouts")
